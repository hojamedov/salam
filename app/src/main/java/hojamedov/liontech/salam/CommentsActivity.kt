...
import hojamedov.liontech.salam.Adapter.CommentAdapter
import hojamedov.liontech.salam.Model.Comment
...
class CommentsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        post_comment.setOnClickListener(View.OnClickListener {
            ...
            {
                Toast.makeText(this@CommentsActivity, "Ilki teswiriňizi ýazyň", Toast.LENGTH_LONG).show()
            }
            else
            {
                addComment()
